...
<simconf version="2022112801">
  <simulation>
    ...
    <motetype>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="65.2432292358736" y="-0.93996748627173" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>8</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="46.79858720283225" y="45.46927243555702" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>9</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="0.93996748627174" y="65.2432292358736" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>10</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="-45.46927243555702" y="46.79858720283224" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>11</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="-0.93996748627173" y="-65.2432292358736" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>14</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="45.46927243555702" y="-46.79858720283225" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>15</id>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.298487954869464 0.0 0.0 1.298487954869464 202.66413876187804 165.84345772540217</viewport>
    </plugin_config>
  ...
  <plugin>
    ...
    <plugin_config>
      <positions>[CONFIG_DIR]/positionfiles/mvmtof_circle_15n_1800s.dat</positions>
    </plugin_config>
    <bounds x="38" y="472" height="200" width="500" z="2" />
  </plugin>
  <plugin>
